  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe2, getSnapshot) {
        didWarnOld18Alpha || void 0 === React144.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React144 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React144.useState, useEffect40 = React144.useEffect, useLayoutEffect6 = React144.useLayoutEffect, useDebugValue = React144.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
      exports.useSyncExternalStore = void 0 !== React144.useSyncExternalStore ? React144.useSyncExternalStore : shim;
...
function createSlot(ownerName) {
  ...
  const Slot210 = React2.forwardRef((props, forwardedRef) => {
...
function createSlot5(ownerName) {
  ...
  const Slot210 = React21.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlot6(ownerName) {
  ...
  const Slot210 = React29.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React29.isValidElement(newElement) ? React29.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var FocusScope = React31.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
...
function createSlot7(ownerName) {
  ...
  const Slot210 = React32.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime22.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React32.isValidElement(newElement) ? React32.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React32.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime27.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React47.Children.map(children, (child) => (0, import_jsx_runtime27.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime27.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
function createSlot9(ownerName) {
  ...
  const Slot210 = React48.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime28.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React48.isValidElement(newElement) ? React48.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React48.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
function createSlot10(ownerName) {
  ...
  const Slot210 = React50.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime30.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React50.isValidElement(newElement) ? React50.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable10(child) {
  return React50.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER10;
}
...
var AspectRatio = React52.forwardRef(
  (props, forwardedRef) => {
...
function createSlot11(ownerName) {
  ...
  const Slot210 = React53.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime33.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React53.isValidElement(newElement) ? React53.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable11(child) {
  return React53.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER11;
}
...
var Avatar = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React55.useState("idle");
...
var AvatarImage = React55.forwardRef(
  (props, forwardedRef) => {
...
var AvatarFallback = React55.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React55.useState(delayMs === void 0);
    React55.useEffect(() => {
      if (delayMs !== void 0) {
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React55.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React55.useState(
...
function useSize(element) {
  const [size4, setSize] = React57.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function isSlottable12(child) {
  return React58.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER12;
}
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React60.useState(null);
  const [bubbleInput, setBubbleInput] = React60.useState(null);
...
var CheckboxTrigger = React60.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React60.useRef(checked);
    React60.useEffect(() => {
...
var Checkbox = React60.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCheckbox,
      name,
...
var CheckboxIndicator = React60.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React60.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React60.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime38.jsx)(
      Primitive10.input,
      {
        type: "checkbox",
...
function createSlot13(ownerName) {
  ...
  const Slot210 = React61.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React61.Children.count(newElement) > 1) return React61.Children.only(null);
          return React61.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime39.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React61.isValidElement(newElement) ? React61.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone13(ownerName) {
  const SlotClone = React61.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React61.isValidElement(children)) {
      ...
      if (children.type !== React61.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React61.cloneElement(children, props2);
    }
    return React61.Children.count(children) > 1 ? React61.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable13(child) {
  return React61.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER13;
}
...
var Primitive11 = NODES11.reduce((primitive, node) => {
  ...
  const Node2 = React62.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function createSlot14(ownerName) {
  ...
  const Slot210 = React64.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime41.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React64.isValidElement(newElement) ? React64.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable14(child) {
  return React64.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER14;
}
...
var NAME4 = "Arrow";
var Arrow = React66.forwardRef((props, forwardedRef) => {
...
function createSlot15(ownerName) {
  ...
  const Slot210 = React67.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime44.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React67.isValidElement(newElement) ? React67.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable15(child) {
  return React67.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER15;
}
...
var Primitive13 = NODES13.reduce((primitive, node) => {
  ...
  const Node2 = React68.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var PopperContent = React69.forwardRef(
  (props, forwardedRef) => {
    ...
    const [content, setContent] = React69.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [arrow4, setArrow] = React69.useState(null);
...
function createSlot16(ownerName) {
  ...
  const Slot210 = React70.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime47.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React70.isValidElement(newElement) ? React70.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable16(child) {
  return React70.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER16;
}
...
function createSlot17(ownerName) {
  ...
  const Slot210 = React72.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime49.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React72.isValidElement(newElement) ? React72.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable17(child) {
  return React72.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER17;
}
...
var RovingFocusGroup = React74.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = React74.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React74.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection2(__scopeRovingFocusGroup);
  const isClickFocusRef = React74.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React74.useState(0);
  React74.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime51.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React74.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React74.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React74.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React74.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React74.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React75.useRef(false);
  ...
  return (0, import_jsx_runtime52.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime52.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime52.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React75.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React75.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
...
var MenuRootContentNonModal = React75.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
  return (0, import_jsx_runtime52.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React75.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React75.useState(null);
    const contentRef = React75.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React75.useRef(0);
    const searchRef = React75.useRef("");
    const pointerGraceTimerRef = React75.useRef(0);
    const pointerGraceIntentRef = React75.useRef(null);
    const pointerDirRef = React75.useRef("right");
    const lastPointerXRef = React75.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React75.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React75.useCallback((event) => {
    ...
    return (0, import_jsx_runtime52.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React75.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React75.useCallback(
          (event) => {
        ...
        onPointerGraceIntentChange: React75.useCallback((intent) => {
...
var MenuGroup = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React75.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React75.useState("");
    React75.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React75.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React75.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React75.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React75.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React75.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React75.useEffect(() => {
...
var MenuSubContent = React75.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopeMenu);
...
var ContextMenu = (props) => {
  ...
  const handleOpenChange = React76.useCallback(
    (open2) => {
      setOpen(open2);
...
var ContextMenuTrigger = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React76.useRef({ x: 0, y: 0 });
    const virtualRef = React76.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React76.useRef(0);
    const clearLongPress = React76.useCallback(
    ...
    React76.useEffect(() => clearLongPress, [clearLongPress]);
    React76.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React76.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React76.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React76.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React76.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React76.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React76.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React76.forwardRef((props, forwardedRef) => {
...
function createSlot18(ownerName) {
  ...
  const Slot210 = React77.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime54.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React77.isValidElement(newElement) ? React77.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable18(child) {
  return React77.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER18;
}
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime56.jsx)(
    DropdownMenuProvider,
    {
      ...
      open,
      onOpenChange: setOpen,
      onOpenToggle: React79.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      modal,
...
var DropdownMenuTrigger = React79.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React79.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...contentProps } = props;
    const context = useDropdownMenuContext(CONTENT_NAME8, __scopeDropdownMenu);
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    const hasInteractedOutsideRef = React79.useRef(false);
    return (0, import_jsx_runtime56.jsx)(
      Content23,
      {
        id: context.contentId,
...
var DropdownMenuGroup = React79.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React79.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem = React79.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React79.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React79.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React79.forwardRef((props, forwardedRef) => {
...
function createSlot19(ownerName) {
  ...
  const Slot210 = React80.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime57.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React80.isValidElement(newElement) ? React80.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable19(child) {
  return React80.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER19;
}
...
var NAME5 = "Label";
var Label3 = React82.forwardRef((props, forwardedRef) => {
...
var Form = React83.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React83.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React83.useState({});
    const getFieldValidity = React83.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React83.useCallback(
    ...
    const handleFieldValiditionClear = React83.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React83.useState({});
    const getFieldCustomMatcherEntries = React83.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React83.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React83.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React83.useState({});
    const getFieldCustomErrors = React83.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React83.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React83.useState({});
    const handleFieldMessageIdAdd = React83.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React83.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React83.useCallback(
...
var FormField = React83.forwardRef(
  (props, forwardedRef) => {
...
var FormLabel = React83.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React83.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React83.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React83.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React83.forwardRef(
  (props, forwardedRef) => {
...
var FormBuiltInMessage = React83.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React83.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React83.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React83.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React83.forwardRef(
  (props, forwardedRef) => {
...
function createSlot20(ownerName) {
  ...
  const Slot210 = React84.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime61.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React84.isValidElement(newElement) ? React84.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable20(child) {
  return React84.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER20;
}
...
var HoverCard = (props) => {
  ...
  const closeTimerRef = React86.useRef(0);
  const hasSelectionRef = React86.useRef(false);
  const isPointerDownOnContentRef = React86.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React86.useCallback(() => setOpen(false), [setOpen]);
  React86.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React86.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContent = React86.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React86.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React86.useState(false);
  React86.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React86.forwardRef(
  (props, forwardedRef) => {
...
function createSlot21(ownerName) {
  ...
  const Slot210 = React87.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime64.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React87.isValidElement(newElement) ? React87.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable21(child) {
  return React87.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER21;
}
...
var Primitive19 = NODES19.reduce((primitive, node) => {
  ...
  const Node2 = React88.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var NAME6 = "Label";
var Label5 = React89.forwardRef((props, forwardedRef) => {
...
function createSlot22(ownerName) {
  ...
  const Slot210 = React90.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime67.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React90.isValidElement(newElement) ? React90.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Menubar = React92.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React92.useState(null);
    return (0, import_jsx_runtime69.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React92.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React92.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React92.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React92.useRef(false);
...
var MenubarTrigger = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarContent = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React92.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React92.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React92.forwardRef(
  (props, forwardedRef) => {
...
function createSlot23(ownerName) {
  ...
  const Slot210 = React93.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime70.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React93.isValidElement(newElement) ? React93.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var NavigationMenu = React95.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React95.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React95.useRef(0);
    const closeTimerRef = React95.useRef(0);
    const skipDelayTimerRef = React95.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React95.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React95.useCallback(() => {
      window.clearTimeout(closeTimerRef.current);
      closeTimerRef.current = window.setTimeout(() => setValue(""), 150);
    }, [setValue]);
    const handleOpen = React95.useCallback(
      (itemValue) => {
        window.clearTimeout(closeTimerRef.current);
        setValue(itemValue);
      },
    ...
    const handleDelayedOpen = React95.useCallback(
      (itemValue) => {
...
var NavigationMenuSub = React95.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewport, setViewport] = React95.useState(null);
  const [viewportContent, setViewportContent] = React95.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React95.useState(null);
  return (0, import_jsx_runtime72.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React95.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React95.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React95.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React95.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, value: valueProp, ...itemProps } = props;
    const autoValue = useId();
    const value = valueProp || autoValue || "LEGACY_REACT_AUTO_VALUE";
    const contentRef = React95.useRef(null);
    const triggerRef = React95.useRef(null);
    const focusProxyRef = React95.useRef(null);
    const restoreContentTabOrderRef = React95.useRef(() => {
    });
    const wasEscapeCloseRef = React95.useRef(false);
    const handleContentEntry = React95.useCallback((side = "start") => {
    ...
    const handleContentExit = React95.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
...
var NavigationMenuTrigger = React95.forwardRef((props, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = React95.useRef(false);
  const wasClickCloseRef = React95.useRef(false);
...
var NavigationMenuLink = React95.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React95.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React95.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React95.useState(
    null
  );
  const [position, setPosition] = React95.useState(null);
...
var NavigationMenuContent = React95.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React95.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React95.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React95.useRef(null);
  ...
  const motionAttribute = React95.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React95.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React95.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React95.useState(null);
  const [content, setContent] = React95.useState(null);
...
var FocusGroup = React95.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React95.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
function createSlot24(ownerName) {
  ...
  const Slot210 = React96.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime73.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React96.isValidElement(newElement) ? React96.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable24(child) {
  return React96.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER24;
}
...
var OneTimePasswordField = React98.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React98.useCallback(
      (value2) => {
    ...
    const controlledValue = React98.useMemo(() => {
    ...
    const validationTypeRef = React98.useRef(validation);
    React98.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React98.useRef(null);
    const userActionRef = React98.useRef(null);
    ...
    const locateForm = React98.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React98.useCallback(() => {
    ...
    const valueRef = React98.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React98.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React98.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React98.useState(null);
  ...
  const keyboardActionTimeoutRef = React98.useRef(null);
  React98.useEffect(() => {
    return () => {
...
function createSlot25(ownerName) {
  ...
  const Slot210 = React99.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React99.Children.count(newElement) > 1) return React99.Children.only(null);
          return React99.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime76.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React99.isValidElement(newElement) ? React99.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone25(ownerName) {
  const SlotClone = React99.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React99.isValidElement(children)) {
      const childrenRef = getElementRef26(children);
      const props2 = mergeProps25(slotProps, children.props);
      if (children.type !== React99.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React99.cloneElement(children, props2);
    }
    return React99.Children.count(children) > 1 ? React99.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable25(child) {
  return React99.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER25;
}
...
var Primitive23 = NODES23.reduce((primitive, node) => {
  ...
  const Node2 = React100.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React101.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React101.useCallback(
  ...
  const focusState = React101.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React101.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React101.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React101.useState(void 0);
    const elementRef = React101.useRef(null);
...
var PasswordToggleFieldIcon = React101.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
function createSlot26(ownerName) {
  ...
  const Slot210 = React102.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React102.Children.count(newElement) > 1) return React102.Children.only(null);
          return React102.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime79.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React102.isValidElement(newElement) ? React102.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone26(ownerName) {
  const SlotClone = React102.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React102.isValidElement(children)) {
      ...
      if (children.type !== React102.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React102.cloneElement(children, props2);
    }
...
function isSlottable26(child) {
  return React102.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER26;
}
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React104.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return (0, import_jsx_runtime81.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime81.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React104.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React104.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React104.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React104.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContent = React104.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React104.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const contentRef = React104.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React104.useRef(false);
    React104.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
...
var PopoverContentNonModal = React104.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const hasInteractedOutsideRef = React104.useRef(false);
    const hasPointerDownOutsideRef = React104.useRef(false);
...
var PopoverContentImpl = React104.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React104.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React104.forwardRef(
  (props, forwardedRef) => {
...
function createSlot27(ownerName) {
  ...
  const Slot210 = React105.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime82.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React105.isValidElement(newElement) ? React105.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Progress = React107.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
...
var ProgressIndicator = React107.forwardRef(
  (props, forwardedRef) => {
...
function createSlot28(ownerName) {
  ...
  const Slot210 = React108.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React108.Children.count(newElement) > 1) return React108.Children.only(null);
          return React108.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime85.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React108.isValidElement(newElement) ? React108.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone28(ownerName) {
  const SlotClone = React108.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React108.isValidElement(children)) {
      const childrenRef = getElementRef29(children);
      const props2 = mergeProps28(slotProps, children.props);
      if (children.type !== React108.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React108.cloneElement(children, props2);
    }
    return React108.Children.count(children) > 1 ? React108.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable28(child) {
  return React108.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER28;
}
...
var Primitive26 = NODES26.reduce((primitive, node) => {
  ...
  const Node2 = React109.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Radio = React110.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React110.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React110.useRef(false);
...
var RadioIndicator = React110.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React110.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
function createSlot29(ownerName) {
  ...
  const Slot210 = React111.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime89.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React111.isValidElement(newElement) ? React111.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable29(child) {
  return React111.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER29;
}
...
function useStateMachine2(initialState, machine) {
  return React113.useReducer((state, event) => {
    const nextState = machine[state][event];
    return nextState ?? state;
  }, initialState);
}
...
function createSlot30(ownerName) {
  ...
  const Slot210 = React114.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React114.Children.count(newElement) > 1) return React114.Children.only(null);
          return React114.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime92.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React114.isValidElement(newElement) ? React114.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone30(ownerName) {
  const SlotClone = React114.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React114.isValidElement(children)) {
      const childrenRef = getElementRef31(children);
      const props2 = mergeProps30(slotProps, children.props);
      if (children.type !== React114.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React114.cloneElement(children, props2);
    }
    return React114.Children.count(children) > 1 ? React114.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable30(child) {
  return React114.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER30;
}
...
var Primitive28 = NODES28.reduce((primitive, node) => {
  ...
  const Node2 = React115.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React116.useState(null);
  const [valueNode, setValueNode] = React116.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React116.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React116.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React116.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime94.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime94.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React116.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React116.useCallback((option) => {
...
var SelectTrigger = React116.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React116.useRef("touch");
...
var SelectValue = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React116.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React116.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React116.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [viewport, setViewport] = React116.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React116.useState(null);
    const [selectedItemText, setSelectedItemText] = React116.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React116.useState(false);
    const firstValidItemFoundRef = React116.useRef(false);
    React116.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React116.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React116.useCallback(
    ...
    const itemRefCallback = React116.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React116.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React116.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React116.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React116.useState(null);
  const [content, setContent] = React116.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React116.useRef(false);
  const shouldRepositionRef = React116.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React116.useCallback(() => {
  ...
  const handleScrollButtonChange = React116.useCallback(
    (node) => {
...
var SelectPopperPosition = React116.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React116.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React116.useRef(0);
...
var SelectGroup = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React116.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React116.useState(textValueProp ?? "");
    const [isFocused, setIsFocused] = React116.useState(false);
    ...
    return (0, import_jsx_runtime94.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React116.useCallback((node) => {
...
var SelectItemText = React116.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React116.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React116.useMemo(
...
var SelectItemIndicator = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React116.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React116.useState(false);
...
var SelectScrollDownButton = React116.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React116.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React116.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React116.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React116.useCallback(() => {
...
var SelectSeparator = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React116.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React116.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React116.useRef("");
  const timerRef = React116.useRef(0);
  const handleTypeaheadSearch = React116.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React116.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React116.useEffect(() => {
...
function createSlot31(ownerName) {
  ...
  const Slot210 = React117.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React117.Children.count(newElement) > 1) return React117.Children.only(null);
          return React117.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime95.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React117.isValidElement(newElement) ? React117.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone31(ownerName) {
  const SlotClone = React117.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React117.isValidElement(children)) {
      const childrenRef = getElementRef32(children);
      const props2 = mergeProps31(slotProps, children.props);
      if (children.type !== React117.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React117.cloneElement(children, props2);
    }
    return React117.Children.count(children) > 1 ? React117.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable31(child) {
  return React117.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER31;
}
...
var Primitive29 = NODES29.reduce((primitive, node) => {
  ...
  const Node2 = React118.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Separator4 = React119.forwardRef((props, forwardedRef) => {
...
function createSlot32(ownerName) {
  ...
  const Slot210 = React120.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React120.Children.count(newElement) > 1) return React120.Children.only(null);
          return React120.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime98.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React120.isValidElement(newElement) ? React120.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone32(ownerName) {
  const SlotClone = React120.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React120.isValidElement(children)) {
      const childrenRef = getElementRef33(children);
      const props2 = mergeProps32(slotProps, children.props);
      if (children.type !== React120.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React120.cloneElement(children, props2);
    }
    return React120.Children.count(children) > 1 ? React120.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable32(child) {
  return React120.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER32;
}
...
var Primitive30 = NODES30.reduce((primitive, node) => {
  ...
  const Node2 = React121.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Slider = React122.forwardRef(
  (props, forwardedRef) => {
    const {
      name,
      min: min2 = 0,
    ...
    const thumbRefs = React122.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React122.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React122.useRef(values);
...
var SliderHorizontal = React122.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React122.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React122.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React122.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React122.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React122.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React122.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React122.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React122.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React122.useMemo(
...
var SliderThumbImpl = React122.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React122.forwardRef(
...
function createSlot33(ownerName) {
  ...
  const Slot210 = React123.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React123.Children.count(newElement) > 1) return React123.Children.only(null);
          return React123.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime101.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React123.isValidElement(newElement) ? React123.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone33(ownerName) {
  const SlotClone = React123.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React123.isValidElement(children)) {
      const childrenRef = getElementRef34(children);
      const props2 = mergeProps33(slotProps, children.props);
      if (children.type !== React123.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React123.cloneElement(children, props2);
    }
    return React123.Children.count(children) > 1 ? React123.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable33(child) {
  return React123.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER33;
}
...
var Primitive31 = NODES31.reduce((primitive, node) => {
  ...
  const Node2 = React124.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Switch = React125.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React125.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React125.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
...
var SwitchThumb = React125.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React125.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
function createSlot34(ownerName) {
  ...
  const Slot210 = React126.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime104.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React126.isValidElement(newElement) ? React126.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable34(child) {
  return React126.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER34;
}
...
var TabsList = React128.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React128.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React128.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React128.useRef(isSelected);
    React128.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
function createSlot35(ownerName) {
  ...
  const Slot210 = React129.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React129.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable35);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React129.Children.count(newElement) > 1) return React129.Children.only(null);
          return React129.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime107.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React129.isValidElement(newElement) ? React129.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone35(ownerName) {
  const SlotClone = React129.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React129.isValidElement(children)) {
      const childrenRef = getElementRef36(children);
      const props2 = mergeProps35(slotProps, children.props);
      if (children.type !== React129.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React129.cloneElement(children, props2);
    }
    return React129.Children.count(children) > 1 ? React129.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable35(child) {
  return React129.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER35;
}
...
var Primitive33 = NODES33.reduce((primitive, node) => {
  ...
  const Node2 = React130.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var ToastProvider = (props) => {
  ...
  const [viewport, setViewport] = React131.useState(null);
  const [toastCount, setToastCount] = React131.useState(0);
  const isFocusedToastEscapeKeyDownRef = React131.useRef(false);
  const isClosePausedRef = React131.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime109.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime109.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React131.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React131.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React131.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React131.useRef(null);
    const headFocusProxyRef = React131.useRef(null);
    const tailFocusProxyRef = React131.useRef(null);
    const ref = React131.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref, context.onViewportChange);
    ...
    const getSortedTabbableCandidates = React131.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React131.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React131.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React131.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React131.useRef(null);
    const swipeDeltaRef = React131.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React131.useRef(0);
    const closeTimerRemainingTimeRef = React131.useRef(duration);
    const closeTimerRef = React131.useRef(0);
    ...
    const startTimer = React131.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React131.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React131.useState(false);
  const [isAnnounced, setIsAnnounced] = React131.useState(false);
...
var ToastTitle = React131.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React131.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React131.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React131.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React131.forwardRef((props, forwardedRef) => {
...
function createSlot36(ownerName) {
  ...
  const Slot210 = React132.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime110.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React132.isValidElement(newElement) ? React132.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var SLOTTABLE_IDENTIFIER36 = /* @__PURE__ */ Symbol("radix.slottable");
...
function isSlottable36(child) {
  return React132.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER36;
}
...
var NAME8 = "Toggle";
var Toggle = React134.forwardRef((props, forwardedRef) => {
...
function createSlot37(ownerName) {
  ...
  const Slot210 = React135.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React135.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable37);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React135.Children.count(newElement) > 1) return React135.Children.only(null);
          return React135.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime113.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React135.isValidElement(newElement) ? React135.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone37(ownerName) {
  const SlotClone = React135.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React135.isValidElement(children)) {
      const childrenRef = getElementRef38(children);
      const props2 = mergeProps37(slotProps, children.props);
      if (children.type !== React135.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React135.cloneElement(children, props2);
    }
    return React135.Children.count(children) > 1 ? React135.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER37 = /* @__PURE__ */ Symbol("radix.slottable");
...
function isSlottable37(child) {
  return React135.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER37;
}
...
var Primitive35 = NODES35.reduce((primitive, node) => {
  ...
  const Node2 = React136.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function createSlot38(ownerName) {
  ...
  const Slot210 = React138.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React138.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable38);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React138.Children.count(newElement) > 1) return React138.Children.only(null);
          return React138.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime116.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React138.isValidElement(newElement) ? React138.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone38(ownerName) {
  const SlotClone = React138.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React138.isValidElement(children)) {
      const childrenRef = getElementRef39(children);
      const props2 = mergeProps38(slotProps, children.props);
      if (children.type !== React138.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React138.cloneElement(children, props2);
    }
    return React138.Children.count(children) > 1 ? React138.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER38 = /* @__PURE__ */ Symbol("radix.slottable");
...
function isSlottable38(child) {
  return React138.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER38;
}
...
var Primitive36 = NODES36.reduce((primitive, node) => {
  ...
  const Node2 = React139.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Toolbar = React140.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React140.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React140.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React140.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React140.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React140.forwardRef(
  (props, forwardedRef) => {
...
function createSlot39(ownerName) {
  ...
  const Slot210 = React141.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React141.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable39);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React141.Children.count(newElement) > 1) return React141.Children.only(null);
          return React141.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime119.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React141.isValidElement(newElement) ? React141.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone39(ownerName) {
  const SlotClone = React141.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React141.isValidElement(children)) {
      const childrenRef = getElementRef40(children);
      const props2 = mergeProps39(slotProps, children.props);
      if (children.type !== React141.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React141.cloneElement(children, props2);
    }
    return React141.Children.count(children) > 1 ? React141.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER39 = /* @__PURE__ */ Symbol("radix.slottable");
...
function isSlottable39(child) {
  return React141.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER39;
}
...
var Primitive37 = NODES37.reduce((primitive, node) => {
  ...
  const Node2 = React142.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React143.useRef(true);
  const isPointerInTransitRef = React143.useRef(false);
  const skipDelayTimerRef = React143.useRef(0);
  React143.useEffect(() => {
  ...
  return (0, import_jsx_runtime121.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React143.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React143.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React143.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React143.useState(null);
  const contentId = useId();
  const openTimerRef = React143.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React143.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React143.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React143.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    wasOpenDelayedRef.current = false;
    setOpen(true);
  }, [setOpen]);
  const handleClose = React143.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    setOpen(false);
  }, [setOpen]);
  const handleDelayedOpen = React143.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime121.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime121.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React143.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React143.useCallback(() => {
...
var TooltipTrigger = React143.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React143.useRef(false);
    const hasPointerMoveOpenedRef = React143.useRef(false);
    const handlePointerUp = React143.useCallback(() => isPointerDownRef.current = false, []);
    React143.useEffect(() => {
...
var TooltipContent = React143.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React143.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React143.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React143.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React143.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React143.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React143.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React143.forwardRef(
  (props, forwardedRef) => {
